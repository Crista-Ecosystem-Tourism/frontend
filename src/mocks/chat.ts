...
export const welcomeMessage: ChatMessage = {
  id: 'welcome',
  role: 'assistant',
  content: `Привет! 👋 Я ваш персональный AI-помощник по путешествиям.

Я помогу спланировать идеальную поездку:
• Подберу лучшие места для посещения
• Составлю маршрут по дням
• Подскажу где вкусно поесть
• Расскажу о ценах и времени

**Напишите город и количество дней**, например:
"Краснодар на 3 дня" или "Хочу в Москву на выходные"`,
